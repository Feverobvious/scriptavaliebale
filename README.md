...
local Window = OrionLib:MakeWindow({Name = "Amassaneis Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Amassaneis Hub"})
...
W:AddLabel("[+] Amassaneis Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Amassaneis Hub(Noitification)",
